...
class RiskManager:
    ...
    def can_open_trade(
        ...
        # 1b. Total open risk check (use effective rate after Kelly/drawdown brake)
        effective_risk_pct = self._get_effective_risk_fraction() * 100.0
        total_open_risk = current_open_positions * effective_risk_pct
