...
# -- MT5 / Deriv Connection ---------------------------------------------------
MT5_SYMBOL = "Volatility 75 Index"   # Default Deriv synthetic index
MT5_TIMEFRAME = "H1"                 # Candle timeframe (M1/M5/M15/M30/H1/H4/D1)
MT5_BARS = 8000                      # Historical bars to fetch from MT5
