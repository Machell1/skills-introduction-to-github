"""
FNID Web Application Configuration

Controlled input definitions based on Jamaica Constabulary Force
terminology, Firearms Act 2022, Dangerous Drugs Act, POCA 2007,
Bail Act 2023, Gun Court Act 1974, and DPP protocols.
"""

import os

BASE_DIR = os.path.dirname(os.path.abspath(__file__))
DB_PATH = os.path.join(BASE_DIR, "data", "fnid.db")
UPLOAD_DIR = os.path.join(BASE_DIR, "data", "uploads")
EXPORT_DIR = os.path.join(BASE_DIR, "data", "exports")
SECRET_KEY = os.environ.get("FNID_SECRET_KEY", "fnid-area3-dev-key-change-in-prod")

# FNID Area 3 covers these parishes
FNID_PARISHES = ["Manchester", "St. Elizabeth", "Clarendon"]

# =================================================================
#  CONTROLLED INPUT DEFINITIONS - JCF Terminology
#  All dropdown values are based on official JCF forms, registers,
...
# Based on JCF operational requirements, DPP protocols, and statutory mandates
