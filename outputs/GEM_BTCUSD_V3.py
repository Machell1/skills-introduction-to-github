...
STOP_MULTIPLIER = float(os.environ.get("STOP_MULTIPLIER", "1.8"))
TP_MULTIPLIER = float(os.environ.get("TP_MULTIPLIER", "5.0"))

# Trailing Stop
TRAIL_LOCK_R = float(os.environ.get("TRAIL_LOCK_R", "0.3"))
TRAIL_TIGHT_MULT = float(os.environ.get("TRAIL_TIGHT_MULT", "0.8"))
TRAIL_VTIGHT_MULT = float(os.environ.get("TRAIL_VTIGHT_MULT", "0.5"))

# Exposure & Risk
MAX_EXPOSURE_LIMIT = float(os.environ.get("MAX_EXPOSURE_LIMIT", "0.08"))
DD_HALT = float(os.environ.get("DD_HALT", "0.05"))
MAX_HOLDING_BARS = int(os.environ.get("MAX_HOLDING_BARS", "80"))
...
RISK_TIER_1 = float(os.environ.get("RISK_TIER_1", "0.025"))  # < $500
RISK_TIER_2 = float(os.environ.get("RISK_TIER_2", "0.020"))  # $500-$1000
...
PYRAMID_ADD_1_AT_R = float(os.environ.get("PYRAMID_ADD_1_AT_R", "0.75"))
PYRAMID_ADD_2_AT_R = float(os.environ.get("PYRAMID_ADD_2_AT_R", "1.5"))
PYRAMID_ADD_3_AT_R = float(os.environ.get("PYRAMID_ADD_3_AT_R", "2.5"))
PYRAMID_ADD_1_SIZE = float(os.environ.get("PYRAMID_ADD_1_SIZE", "0.60"))
PYRAMID_ADD_2_SIZE = float(os.environ.get("PYRAMID_ADD_2_SIZE", "0.50"))
PYRAMID_ADD_3_SIZE = float(os.environ.get("PYRAMID_ADD_3_SIZE", "0.30"))
PYRAMID_MIN_CONFLUENCE = int(os.environ.get("PYRAMID_MIN_CONFLUENCE", "35"))
PYRAMID_STOP_ATR_MULT = float(os.environ.get("PYRAMID_STOP_ATR_MULT", "1.0"))
PYRAMID_LOCK_AFTER_ADD1_R = float(os.environ.get("PYRAMID_LOCK_AFTER_ADD1_R", "0.3"))
PYRAMID_LOCK_AFTER_ADD2_R = float(os.environ.get("PYRAMID_LOCK_AFTER_ADD2_R", "0.75"))
PYRAMID_LOCK_AFTER_ADD3_R = float(os.environ.get("PYRAMID_LOCK_AFTER_ADD3_R", "1.5"))
PYRAMID_MAX_ADDON_EXPOSURE = float(os.environ.get("PYRAMID_MAX_ADDON_EXPOSURE", "0.04"))
PYRAMID_HTF_MODE = os.environ.get("PYRAMID_HTF_MODE", "any")  # "any" or "both"
PYRAMID_ADX_MIN = float(os.environ.get("PYRAMID_ADX_MIN", "20"))
